...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard | Mahishadal Sadar YCTC</title>
            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index-2.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="../assets/images/logo/logo-white.png" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="../assets/images/logo/logo-white.png" alt="" height="17">
                        </span>
                    </a>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Chanchal Patra</span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">Director</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome Chanchal!</h6>
...
<div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.php" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="../assets/images/logo/logo-white.png" alt="" height="50">
                    </span>
                    <span class="logo-lg">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                                <i class="ri-account-circle-line"></i> <span data-key="t-authentication">Students</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="addstd.php" class="nav-link"  role="button" aria-expanded="false" aria-controls="sidebarSignIn" data-key="t-signin"> Add Student
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="viewstd.php" class="nav-link" role="button" aria-expanded="false" aria-controls="sidebarSignIn" data-key="t-signin"> View Students
                                        </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPages">
                                <i class="ri-pages-line"></i> <span data-key="t-pages">Course</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarPages">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="addcourse.php" class="nav-link" data-key="t-starter"> Add Course </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="viewcourse.php" class="nav-link" data-key="t-starter"> View Course </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarLanding">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="addques.php" class="nav-link" data-key="t-one-page"> Add Question </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="viewques.php" class="nav-link" data-key="t-one-page"> View Question </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarUI">
                                <i class="ri-pencil-ruler-2-line"></i> <span data-key="t-base-ui">Payment</span>
                            </a>
                            <div class="collapse menu-dropdown mega-dropdown-menu" id="sidebarUI">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="pay.php" class="nav-link" data-key="t-alerts">Pay</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="payhis.php" class="nav-link" data-key="t-badges">Pay History</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarAdvanceUI">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="addnotice.php" class="nav-link" data-key="t-sweet-alerts">Add</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="viewnotice.php" class="nav-link" data-key="t-nestable-list">View</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
...
<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <script>document.write(new Date().getFullYear())</script> © Chandan.
            </div>
            <div class="col-sm-6">
